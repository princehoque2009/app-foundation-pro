...
const settingsItems: MenuItem[] = [
  ...
  },
  {
    ...
    icon: HelpCircle,
    label: "Help & Support",
    description: "Contact, FAQ, guidelines",
    path: "/help",
  },
];
...
const Menu = () => {
  ...
  if (isModerator && !isAdmin) {
    roleItems.push({
      ...
      description: "Review reports & content",
