  ...
  if (isLoading) {
    return (
      <div className="relative">
        <div className="h-[200px] sm:h-[260px] w-full shimmer lg:rounded-[24px] lg:max-w-[1024px] lg:mx-auto" />
      ...
      <div className="relative pb-4">
        <div className="relative w-full overflow-hidden bg-muted h-[180px] sm:h-[220px] md:h-[260px] lg:h-[300px] xl:h-[320px] lg:rounded-[24px] lg:max-w-[1024px] lg:mx-auto lg:border lg:border-border/50 lg:shadow-sm">
          {isOwner ? (
            ...
            <img src={optimizeCloudinaryUrl(profile.cover_photo_url, "c_fill,ar_3:1,g_auto,w_1200")} alt="cover" className="w-full h-full object-cover" />
          ) : (
        ...
        <div className="px-4 sm:px-6 max-w-2xl mx-auto">
          <div className="relative flex items-center justify-between -mt-12 sm:-mt-14">
            ...
            <div className="relative z-10">
              <div className="rounded-full bg-background p-1 shadow-md" onClick={isOwner ? onEditClick : undefined}>
                <Avatar className={cn("h-24 w-24 sm:h-28 sm:w-28", isOwner && "cursor-pointer")}>
                  <AvatarImage src={profile?.avatar_url || ""} alt={profile?.display_name || profile?.username} className="object-cover" />
          ...
          <div className="mt-3 text-center">
            <div className="flex items-center justify-center gap-2 flex-wrap">
              <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-foreground">{profile?.display_name || profile?.username}</h1>
            ...
            {profile?.social_links && typeof profile.social_links === 'object' && Object.keys(profile.social_links).length > 0 && (
              <div className="pt-3 flex justify-center"><SocialLinksInline links={profile.social_links} /></div>
            )}
