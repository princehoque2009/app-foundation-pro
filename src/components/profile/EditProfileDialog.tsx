            ...
            <div className="space-y-6 pb-6">
              ...
              <div className="space-y-4">
                ...
                <div><Label>Country</Label>
                  <Select value={country} onValueChange={setCountry}><SelectTrigger><SelectValue placeholder="Select country" /></SelectTrigger><SelectContent>{countries.map((c: any) => (<SelectItem key={c.code} value={c.name}><span className="flex items-center gap-2">{getCountryFlag(c.code)} {c.name}</span></SelectItem>))}</SelectContent></Select>
                </div>
                {isVerified && (
                  <div className="rounded-[18px] border border-amber-200 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-amber-950/20 dark:via-yellow-950/15 dark:to-orange-950/10 p-4 space-y-4">
                    ...
                    <div className="rounded-[14px] bg-background/80 border border-border/50 p-3">
                      ...
                      <div className={"rounded-xl overflow-hidden border transition-all " + (profileTheme === 'yellow' ? "border-amber-300 bg-gradient-to-br from-amber-50 to-yellow-50" : profileTheme === 'mono' ? "border-zinc-400 bg-gradient-to-br from-zinc-100 via-zinc-200 to-zinc-300" : "border-border bg-muted/30")}>
                        <div className={"h-[68px] w-full relative " + (profileTheme === 'yellow' ? "bg-gradient-to-br from-amber-100 via-yellow-50 to-orange-50" : profileTheme === 'mono' ? "bg-gradient-to-br from-zinc-100 via-zinc-200 to-zinc-300" : "bg-muted")}>
                          <div className="absolute -bottom-6 left-4 flex items-end gap-3">
                            <div className={"rounded-full bg-background p-0.5 shadow-md " + (profileTheme === 'yellow' ? "ring-2 ring-amber-400" : profileTheme === 'mono' ? "ring-2 ring-zinc-300 shadow-[0_0_0_3px_white,0_0_0_6px_black]" : "ring-2 ring-background")}>
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-3">
                        {[
                          ...
                          { id: 'mono', label: 'Platinum', sub: 'Chrome • Cool' },
                        ].map((t) => (
